      ...
      <section className="container container-page-productOne">
        {[
          products?.productos?.find(
            (elemento) => elemento.id === Number(parametro.id)
          ),
        ].map((product) => (
            ...
            <div className="container-description-product">
              <div className="description-product">
                ...
                <div className="container-icon-start-qualify">
                  ...
                  <i className="bx bx-star"></i>
                  <i className="bx bx-star"></i>
                  <span> | puede agregar una reseña</span>
                </div>
                <div className="price-product-page">${product?.precio}</div>
              ...
              <div className="container-buttons-product-page">
                <div className="buttons-product-page">
                  <div
                    className="button-minus-product-page"
                    onClick={() =>
                  ...
                  <div className="count-product-page">{count}</div>
                  <div
                    className="button-plus-product-page"
            ...
            {products.productos?.map((product) => (
              <li class="list-gallery">
                ...
                <section class="container-description-gallery">
                  ...
                  <span class="description-gallery">{product.descripcion}</span>
                </section>
              </li>
            ))}
          </ul>
